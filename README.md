...
>
> **🎯 Agent Skills Enabled** — 26 specialized skills extend Claude's capabilities across plugins with progressive disclosure

A comprehensive production-ready system combining **62 specialized AI agents**, **15 multi-agent workflow orchestrators**, **26 agent skills**, and **44 development tools** organized into **54 focused, single-purpose plugins** for [Claude Code](https://docs.claude.com/en/docs/claude-code/overview).

## Overview

This unified repository provides everything needed for intelligent automation and multi-agent orchestration across modern software development:

- **54 Focused Plugins** - Granular, single-purpose plugins optimized for minimal token usage and composability
- **62 Specialized Agents** - Domain experts with deep knowledge across architecture, languages, infrastructure, quality, AI/LLM, documentation, and specialized domains
- **26 Agent Skills** - Modular knowledge packages with progressive disclosure for specialized expertise
- **15 Workflow Orchestrators** - Multi-agent coordination systems for complex operations like full-stack development, security hardening, and deployment
...
- **Granular Plugin Architecture**: 54 focused plugins optimized for minimal token usage
- **Comprehensive Tooling**: 44 development tools including test generation, scaffolding, and security scanning
- **100% Agent Coverage**: All plugins include specialized agents
- **Agent Skills**: 26 specialized skills following for progressive disclosure and token efficiency
...
- **[Plugin Reference](docs/plugins.md)** - Complete catalog of all 54 plugins
- **[Agent Reference](docs/agents.md)** - All 62 agents organized by category
- **[Agent Skills](docs/agent-skills.md)** - 26 specialized skills with progressive disclosure
...
### Agent Skills (26 skills across 10 plugins)
...
- **2 Haiku agents** - Fast execution for deterministic tasks
- **60 Sonnet agents** - Complex reasoning and architecture
...
- **100% coverage** - All 62 agents accessible across plugins
...
claude-agents/
├── .claude-plugin/
│   └── marketplace.json          # 54 plugins
├── plugins/
│   ├── javascript-typescript/
│   │   ├── agents/               # 2 JS/TS experts
